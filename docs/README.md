...
For activating the automatic documentation with MkDocs, see [here](https://fpgmaas.github.io/cookiecutter-dbt/features/mkdocs/#enabling-the-documentation-on-github).
